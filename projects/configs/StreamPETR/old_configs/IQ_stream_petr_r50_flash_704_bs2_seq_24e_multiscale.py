...
# train_ann_filename='nuscenes2d_temporal_infos_train.pkl'
# val_ann_filename='nuscenes2d_temporal_infos_val.pkl'
# test_ann_filename='nuscenes2d_temporal_infos_val.pkl'
...
data = dict(
    ...
    train=dict(
        ...
        box_type_3d='LiDAR'),
    val=dict(type=dataset_type, pipeline=test_pipeline, collect_keys=collect_keys + ['img', 'img_metas'], queue_length=queue_length, 
             ann_file=data_root + val_ann_filename, classes=class_names, modality=input_modality),
    test=dict(type=dataset_type, pipeline=test_pipeline, collect_keys=collect_keys + ['img', 'img_metas'], queue_length=queue_length, 
