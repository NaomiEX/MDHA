...
# ! REMEMBER TO CHANGE THIS FOR DIFF EXPERIMENTS
cfg_name = "full_baseline_multrefpts_2gpu"
debug_args = dict(
    debug=True,
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        ...
                        dict(
                            ...
                            mlvl_feats_format=mlvl_feats_format,
                            ref_pts_mode=dec_ref_pts_mode,
                            encode_2d_ref_pts_into_query_pos=True,
                            query_pos_2d_ref_pts_encoding_method="linear",
                        )
                        ],
