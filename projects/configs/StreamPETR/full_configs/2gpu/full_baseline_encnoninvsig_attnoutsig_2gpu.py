...
cfg_name = "full_baseline_encnoninvsig_2gpu"
debug_args = dict(
    debug=True,
...
encoder = dict(
    ...
    use_sigmoid_on_attn_out=use_sigmoid_on_attn_out["encoder"],
...
pts_bbox_head=dict(
        ...
        **obj_det3d_loss_cfg,
        ...
        use_sigmoid_on_attn_out=use_sigmoid_on_attn_out["decoder"],
        ##
        transformer=dict(
