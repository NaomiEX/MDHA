...
cfg_name = "full_baseline_propagatepos_add_1gpu"
debug_args = dict(
    debug=True,
...
encoder = dict(
    ...
    encode_3dpos_method="add", # ! MAJOR CHANGE
    propagate_3d_pos=True, # ! MAJOR CHANGE
...
pts_bbox_head=dict(
        ...
        with_position=True,
        position_range=[-61.2, -61.2, -10.0, 61.2, 61.2, 10.0],
        encode_3d_ref_pts_as_query_pos=True, # ! MAJOR CHANGE
...
model = dict(
    ...
    share_pos_3d_encoding_method=False, # ! MAJOR CHANGE
    ##
    img_backbone=dict(
        type="ResNet",
        depth=50,
