...
cfg_name = "encoder_anchor_preddepth_wloss_2gpu"
...
encoder = dict(
    ...
    pred_ref_pts_depth=True,
    pred_ref_pts_depth_before_spatial_alignment=False,
    loss_depth=dict(type='L1Loss', loss_weight=2.0),
    div_depth_loss_by_target_count=False,
