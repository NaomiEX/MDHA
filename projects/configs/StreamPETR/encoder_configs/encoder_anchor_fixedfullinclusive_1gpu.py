...
debug_args = dict(
    debug=True,
    log_file="./experiments/debug/encoder_only_anchor_fixedfullinclusive_1gpu_log.log"
)
...
encoder = dict(
    ...
    reference_point_generator = dict(
        ...
        coords_depth_files={
            0: "./experiments/depth_coords/agg_res_cams_all_inclusive_176x64.pkl",
            1: "./experiments/depth_coords/agg_res_cams_all_inclusive_88x32.pkl",
            2: "./experiments/depth_coords/agg_res_cams_all_inclusive_44x16.pkl",
            3: "./experiments/depth_coords/agg_res_cams_all_inclusive_22x8.pkl",
        },
        n_levels=4,
