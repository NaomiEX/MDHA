...
debug_args = dict(
    debug=True,
    log_file="./experiments/debug/encoder_only_anchor_fixedvertical_1gpu_log.log"
)
...
encoder = dict(
    ...
    reference_point_generator = dict(
        ...
        coords_depth_files={
            0: "./experiments/depth_coords/agg_res_cams_vertical_64.pkl",
            1: "./experiments/depth_coords/agg_res_cams_vertical_32.pkl",
            2: "./experiments/depth_coords/agg_res_cams_vertical_16.pkl",
            3: "./experiments/depth_coords/agg_res_cams_vertical_8.pkl",
        },
        n_levels=4,
