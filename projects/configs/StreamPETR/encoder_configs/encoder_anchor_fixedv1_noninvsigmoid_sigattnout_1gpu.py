...
debug_args = dict(
    debug=True,
    log_file="./experiments/debug/encoder_only_anchor_fixedv1_noninvsigmoid_sigattnout_1gpu_log.log"
)
...
encoder = dict(
    ...
    reference_point_generator = dict(
        ...
        coords_depth_files="./experiments/depth_coords/agg_again_res_cams.pkl",
        n_levels=4,
        coords_depth_bucket_size=[64, 88], # [h/4, w/8]
