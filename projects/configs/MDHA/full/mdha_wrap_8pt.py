...
test_data_root='./data/nuscenes/' # val set
data = dict(
    workers_per_gpu=4,
    train=dict(
        type=dataset_type,
        ...
        box_type_3d='LiDAR'),
    val=dict(type=dataset_type, data_root=test_data_root, pipeline=test_pipeline, 
    ...
    test=dict(type=dataset_type, data_root=test_data_root, pipeline=test_pipeline, 
              collect_keys=collect_keys + ['img', 'img_metas'], queue_length=queue_length, 
