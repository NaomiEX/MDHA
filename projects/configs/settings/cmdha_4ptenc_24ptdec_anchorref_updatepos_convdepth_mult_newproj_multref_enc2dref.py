...
dec_attn_encode_2d_ref_pts = True
dec_attn_encode_2d_ref_pts_method="linearreluln"
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        ...
                        dict(
                            ...
                            mlvl_feats_format=mlvl_feats_format,
                            ref_pts_mode=dec_ref_pts_mode,
                            encode_2d_ref_pts_into_query_pos=dec_attn_encode_2d_ref_pts,
                            query_pos_2d_ref_pts_encoding_method=dec_attn_encode_2d_ref_pts_method,
                        )
                        ],
